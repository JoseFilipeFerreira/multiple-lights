...
set_target_properties(ospray::ospray PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray.so.2.1.1"
  IMPORTED_SONAME_RELEASE "libospray.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray "${_IMPORT_PREFIX}/lib/libospray.so.2.1.1" )
...
set_target_properties(ospray::ospray_module_ispc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray_module_ispc.so.2.1.1"
  IMPORTED_SONAME_RELEASE "libospray_module_ispc.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray_module_ispc )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray_module_ispc "${_IMPORT_PREFIX}/lib/libospray_module_ispc.so.2.1.1" )
...
set_target_properties(ospray::ospray_imgui PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray_imgui.so.2.1.1"
  IMPORTED_SONAME_RELEASE "libospray_imgui.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray_imgui )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray_imgui "${_IMPORT_PREFIX}/lib/libospray_imgui.so.2.1.1" )
...
set_target_properties(ospray::ospray_testing PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray_testing.so.2.1.1"
  IMPORTED_SONAME_RELEASE "libospray_testing.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray_testing )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray_testing "${_IMPORT_PREFIX}/lib/libospray_testing.so.2.1.1" )
