...
{
 public:
  GLFWOSPRayWindow(const vec2i &windowSize, cpp::Group MeshGroup,  bool modelAvailable = false);
...
//  protected:
  ...
  OSPRayRendererType rendererType{OSPRayRendererType::MYRENDERER};
  std::string rendererTypeStr{"myrenderer"};
